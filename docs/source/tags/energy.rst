...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
| `Notebooks <../notebooks/index.html>`_ > `Hydrogen Facility Operations Introduction <../notebooks/hydrogen-facility-operations-introduction.html>`_
| |github-hydrogen-facility-operations-introduction| |colab-hydrogen-facility-operations-introduction| |deepnote-hydrogen-facility-operations-introduction| |kaggle-hydrogen-facility-operations-introduction| |gradient-hydrogen-facility-operations-introduction| |sagemaker-hydrogen-facility-operations-introduction|
...
| Tags: :ref:`tag-educational`, :ref:`tag-gurobi`, :ref:`tag-energy`, :ref:`tag-hydrogen`, :ref:`tag-mp`
| Author: :ref:`email-eduardo_at_ampl.com` <eduardo@ampl.com>

.. |github-hydrogen-facility-operations-introduction|  image:: https://img.shields.io/badge/github-%23121011.svg?logo=github
    :target: https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/hydrogen/hydrogen_operations.ipynb
    :alt: hydrogen_operations.ipynb
    
.. |colab-hydrogen-facility-operations-introduction| image:: https://colab.research.google.com/assets/colab-badge.svg
    :target: https://colab.research.google.com/github/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/hydrogen/hydrogen_operations.ipynb
    :alt: Open In Colab
    
.. |deepnote-hydrogen-facility-operations-introduction| image:: https://deepnote.com/buttons/launch-in-deepnote-small.svg
    :target: https://deepnote.com/launch?url=https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/hydrogen/hydrogen_operations.ipynb
    :alt: Open In Deepnote
    
.. |kaggle-hydrogen-facility-operations-introduction| image:: https://kaggle.com/static/images/open-in-kaggle.svg
    :target: https://kaggle.com/kernels/welcome?src=https://github.com/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/hydrogen/hydrogen_operations.ipynb
    :alt: Open In Kaggle
    
.. |gradient-hydrogen-facility-operations-introduction| image:: https://assets.paperspace.io/img/gradient-badge.svg
    :target: https://console.paperspace.com/github/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/hydrogen/hydrogen_operations.ipynb
    :alt: Open In Gradient
    
.. |sagemaker-hydrogen-facility-operations-introduction| image:: https://studiolab.sagemaker.aws/studiolab.svg
    :target: https://studiolab.sagemaker.aws/import/github/ampl/colab.ampl.com/blob/master/authors/eduardosalaz/hydrogen/hydrogen_operations.ipynb
    :alt: Open In SageMaker Studio Lab
